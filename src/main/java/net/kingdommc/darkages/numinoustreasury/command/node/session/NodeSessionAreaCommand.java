...
import static net.kingdommc.darkages.numinoustreasury.interaction.NuminousInteractionStatus.SELECTING_AREA_1;
import static net.md_5.bungee.api.ChatColor.GREEN;
import static net.md_5.bungee.api.ChatColor.RED;

public final class NodeSessionAreaCommand implements CommandExecutor, TabCompleter {
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        interactionService.setInteractionStatus(player, SELECTING_AREA_1);
