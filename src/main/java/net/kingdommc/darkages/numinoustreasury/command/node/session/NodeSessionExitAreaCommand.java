...
import static net.kingdommc.darkages.numinoustreasury.interaction.NuminousInteractionStatus.SELECTING_EXIT_AREA_1;
...
public final class NodeSessionExitAreaCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        interactionService.setInteractionStatus(player, SELECTING_EXIT_AREA_1);
