...
public final class NodeSessionExperienceCommand implements CommandExecutor, TabCompleter {

    private final ConversationFactory conversationFactory;

    public NodeSessionExperienceCommand(NuminousTreasury plugin) {
