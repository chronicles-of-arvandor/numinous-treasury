...
class NodeSessionNameCommand(plugin: NuminousTreasury) : CommandExecutor, TabCompleter {
    ...
    override fun onCommand(
        ...
        if (args.size > 0) {
            session.name = args.joinToString(" ")
    ...
    private class NamePrompt : StringPrompt() {
        override fun getPromptText(context: ConversationContext): String {
            return ChatColor.GRAY.toString() + "Please enter the name of the node:"
        }
