...
class NodeSessionExperienceCommand(plugin: NuminousTreasury) : CommandExecutor, TabCompleter {
    ...
    private class ExperiencePrompt : NumericPrompt() {
        override fun getPromptText(context: ConversationContext): String {
            return ChatColor.GRAY.toString() + "Please enter the experience granted when using the node:"
        }
        ...
        override fun acceptValidatedInput(
            ...
            session.experience = input.toInt()
